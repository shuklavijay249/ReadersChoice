...
//https://www.youtube.com/watch?v=lPfQN-Sfnjw&index=3&list=PLrnPJCHvNZuB_7nB5QD-4bNg6tpdEUImQ
...
public class UploadActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void showFileChooser() {
        ...
        startActivityForResult(Intent.createChooser(intent, "Select Content"), PICK_IMAGE_REQUEST);
    }
    ...
    private void uploadFile() {
        ...
        if (filePath != null) {
          ...
          mUploadTask = sRef.putFile(filePath)
